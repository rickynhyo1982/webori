...
class MY_Lang extends CI_Lang {
	...
	***************************************************/
	...
	var $special = array ('pruebas', 'asincrono', 'imagenes');
	
	// where to redirect if no language in URI
	var $default_uri = 'inicio'; 
	...
	function __construct()
	{
		...
		global $RTR;
                ...
                $this->languages = json_decode(file_get_contents('application/language/lang.json'), true);
	...
	function localized($uri)
	{
        ...
        //check if a languaje is avaible
        function available($lang_code) {
            return isset($this->languages[$lang_code]);
        }
