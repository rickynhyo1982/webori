	...
	<tr style="margin:0; padding:0;">
		...
		<td style="margin:0; padding:0;">
				...
				<table bgcolor="#0A0A0A" style="margin:0; padding:0; width: 100%">
					<tr style="margin:0; padding:0;">
						<td style="margin:0; padding:0;"><img alt="RGascat" src="<?php echo base_url(); ?>resources/style/img/logo.png" style="margin:0; padding:0; max-width: 100%;" /></td>
					</tr>
				</table>
				</div>
	...
	<tr style="margin:0; padding:0;">
		...
		<td style="margin:0; padding:0; display:block!important; max-width:600px!important; margin:0 auto!important; /* makes it centered */ clear:both!important;" bgcolor="#FFFFFF">
			...
			<table style="margin:0; padding:0; width: 100%">
				<tr style="margin:0; padding:0;">
					<td style="margin:0; padding:0;">
						<h3 style="line-height: 1.1; margin-bottom:15px; color:#000; font-weight:500; font-size: 27px;">Hola, <?php echo $nombre ?></h3>
						<p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; line-height:1.6; font-size:17px;">Queremos confirmarte que hemos recibido tu mensaje y te contactaremos en la mayor brevedad posible.</p>
						<p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:14px; line-height:1.6;">Gracias por ponerte en contacto con nosotros.</p>
									...
									<table align="left" style="margin:0; padding:0; width: 280px; min-width: 279px; float:left;">
										<tr style="margin:0; padding:0;">
											<td style="margin:0; padding: 15px;">						
												...
												<p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:12px; line-height:1.4;"><b>Email:</b> <a style="color: #2BA6CB;" href="emailto:rgascat@rgascat.com">rgascat@rgascat.com</a></p>		
											</td>
										</tr>
									</table><!-- /column 2 -->
