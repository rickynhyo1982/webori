	...
	<tr style="margin:0; padding:0;">
		...
		<td style="margin:0; padding:0; display:block!important; max-width:600px!important; margin:0 auto!important; /* makes it centered */ clear:both!important;" bgcolor="#FFFFFF">
			...
			<table style="margin:0; padding:0; width: 100%">
				<tr style="margin:0; padding:0;">
					<td style="margin:0; padding:0;">
						<h3 style="line-height: 1.1; margin-bottom:15px; color:#000; font-weight:500; font-size: 27px;">Nuevo mensaje enviado desde el formulario de contacto</h3>
						<p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:14px; line-height:1.6;"><b>Nombre:</b> <?php echo $nombre?></p>
                                                <p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:14px; line-height:1.6;"><b>Teléfono:</b> <?php echo $telefono?></p>
                                                <p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:14px; line-height:1.6;"><b>Mail:</b> <?php echo $mail?></p>
						<p style="margin:0; padding:0;margin-bottom: 10px; font-weight: normal; font-size:14px; line-height:1.6;"><b>Mensaje:</b> <?php echo $mensaje?></p>		
					</td>
				</tr>
			</table>
			</div><!-- /content -->
